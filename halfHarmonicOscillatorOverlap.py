...
np.savetxt('ExcitedState/vrefForPOP.data', v_ref_array_0.T)
np.savetxt('ExcitedState/popForPOP.data', pop_array_0.T)
np.savetxt('ExcitedState/vrefDescFor-POP-POP.data',v_ref_desc_array_0[0].T)
np.savetxt('ExcitedState/vrefDescFor-POP-VREF.data',v_ref_desc_array_0[1].T)
np.savetxt('ExcitedState/popDescFor-POP-VREF.data',pop_desc_array_0[1].T)
np.savetxt('ExcitedState/popDescFor-POP-POP.data',pop_desc_array_0[0].T)
...
np.savetxt('ExcitedState/popForVRefFIXED.data', pop_array_1.T)
np.savetxt('ExcitedState/vref-VREF-descendants-POP.data',v_ref_desc_array_1[0].T)
np.savetxt('ExcitedState/popDescFor-POP-POP.data',pop_desc_array_1[0].T)
np.savetxt('ExcitedState/popDescFor-POP-VREF.data.data',pop_desc_array_1[1].T)
...
np.savetxt('ExcitedState/PsiHist-pop.data',xhists_0[0].T)
np.savetxt('ExcitedState/PsiHist-AVERAGE-pop.data',zip(bin_center,np.average(xhists_0[0],axis=0)))
np.savetxt('ExcitedState/Psi2Hist-pop-pop.data',xhists_0[1].T)
np.savetxt('ExcitedState/Psi2Hist-AVERAGE-pop-pop.data',zip(bin_center,np.average(xhists_0[1],axis=0)))
np.savetxt('ExcitedState/Psi2Hist-pop-vref.data',xhists_0[2].T)
np.savetxt('ExcitedState/Psi2Hist-AVERAGE-pop-vref.data',zip(bin_center,np.average(xhists_0[2],axis=0)))

np.savetxt('ExcitedState/PsiHist-vref.data',xhists_1[0].T)
np.savetxt('ExcitedState/PsiHist-AVERAGE-vref.data',zip(bin_center,np.average(xhists_1[0],axis=0)))
np.savetxt('ExcitedState/Psi2Hist-vref-pop.data',xhists_1[1].T)
np.savetxt('ExcitedState/Psi2Hist-AVERAGE-vref-pop.data',zip(bin_center,np.average(xhists_1[1],axis=0)))
np.savetxt('ExcitedState/Psi2Hist-vref-vref.data',xhists_1[2].T)
np.savetxt('ExcitedState/Psi2Hist-AVERAGE-vref-vref.data',zip(bin_center,np.average(xhists_1[2],axis=0)))
